...
<Cards>
  <Cards.Card
    icon={<BoxIcon />}
    title="Model Page"
    href="https://thangs.com/designer/timothyjackman/3d-model/Fixed%20Hextraction%20Secret%20Flipper%20Tile-884171"
  />
  <Cards.Card
    icon={<AccountIcon />}
    title="Author"
    href="https://thangs.com/designer/timothyjackman"
  />
</Cards>
