...
| Hole | <ul><li><input disabled checked type="checkbox" /></li></ul>|
...
| Alters Ball(s) | <ul><li><input disabled checked type="checkbox" /></li></ul>|
...
| Premium | <ul><li><input disabled checked type="checkbox" /></li></ul>|
| Unique | <ul><li><input disabled checked type="checkbox" /></li></ul>|
| Virtual | <ul><li><input disabled checked type="checkbox" /></li></ul>|
