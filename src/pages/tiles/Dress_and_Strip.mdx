...
<Cards>
  <Cards.Card
    icon={<BoxIcon />}
    title="Model Page"
    href="https://than.gs/m/899753"
  />
  <Cards.Card
    icon={<AccountIcon />}
    title="Author"
    href="https://thangs.com/designer/ransElectronics"
  />
</Cards>
...
| Secret | <ul><li><input disabled checked type="checkbox" /></li></ul>|
...
| Alters Turn(s) | <ul><li><input disabled checked type="checkbox" /></li></ul>|
| Forbidden | <ul><li><input disabled checked type="checkbox" /></li></ul>|
| Novelty | <ul><li><input disabled checked type="checkbox" /></li></ul>|
